...
<%
	...
	if(action.equals("load")){
		...
		String a2 = "select * from user_define_criteria where define_id = "+define_id+" and criteria_table = 4 order by criteria_id asc";
		...
		String a4 = "select * from user_define_mid_criteria where define_id = "+define_id+" and mid_state = 1 order by mid_id asc";
		...
		String a5 = "select * from user_define_mid_criteria where define_id = "+define_id+" and mid_state = 2 order by mid_id asc";
		...
		for(int i = 0; i < criteria_set_in.size(); i++){
			...
			String a3 = "select * from user_define_criteria where define_id = "+define_id+" and criteria_table <> 4 and mid_id="+data_output.get("id")+" order by criteria_id asc";
