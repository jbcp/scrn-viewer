...
<%
	...
	if(action.equals("load")){
		...
		String condition = "select condition_list from result_protocol where project_id ="+project_id+" and eligibility_id ="+eligibility_id;
		...
		String project_id = request.getParameter("project_id");
		String eligibility_id = request.getParameter("eligibility_id");
		String exe_check = "select condition_list, condition_exe_datetime from result_protocol where project_id ="+project_id+" and eligibility_id ="+eligibility_id;
        ...
        if(condition_date == null){
            ...
            String execute = "update result_protocol set condition_exe_datetime = '"+today+"' where project_id ="+project_id+" and eligibility_id ="+eligibility_id;
        ...
        String refresh_condition = "update result_protocol set condition_list = NULL where project_id ="+project_id+" and eligibility_id ="+eligibility_id;
        ...
        String refresh_date = "update result_protocol set condition_exe_datetime = '"+today+"' where project_id ="+project_id+" and eligibility_id ="+eligibility_id;
