...
declare module wijmo.gauge {
    ...
    class Gauge extends Control {
         ...
         * @see:ranges collection are displayed with the same thickness as the gauge's
         * face. Setting @see:stackRanges to true causes the ranges to become
         * narrower, and to be displayed side-by-side.
         */
        stackRanges: boolean;
        /**
